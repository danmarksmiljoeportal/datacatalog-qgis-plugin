# Introduction
The "Danmarks Miljøportals datakatalog" is a QGIS plugin that allows the user to easily find and add any WMTS-, WFS-, and WMS-layer that is available in the "Danmarks Miljøportals datakatalog" from a single place.
...
For more information on how to use the plugin, please refer to the Wiki (https://github.com/danmarksmiljoeportal/datacatalog-qgis-plugin/wiki).
